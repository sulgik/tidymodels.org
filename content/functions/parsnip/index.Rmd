...
htmlwidgets::saveWidget(func_tab, file = "table.html", selfcontained = TRUE)
```
...
mapping_tab <- DT::datatable(args, filter = "top", style = 'bootstrap')
htmlwidgets::saveWidget(mapping_tab, file = "mapping.html", selfcontained = TRUE)
```

<iframe seamless src="mapping.html" width="100%" height="500"></iframe>
